...
public class MQTTService extends Service {
    ...
    private String host = "tcp://max.isasecret.com:1723";
    private String userName = "majinfo2019";
    private String passWord = "Y@_oK2";
    private static String myTopic = "/lights/1/status/";      //要订阅的主题
    private String clientId = "2020";//客户端标识
    ...
    public static void publish(String msg){
        ...
        try {
            if (client != null){
                //注意一个MqttAndroidClient.publish()方法，相当于服务器发布一个消息。
    ...
    private void init() {
        ...
        String message = "{\"MAX\": Phone\"" + clientId + " is missing"+"\"}";
