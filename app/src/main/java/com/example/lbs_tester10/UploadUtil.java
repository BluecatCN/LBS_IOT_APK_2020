...
public class UploadUtil {
    ...
    public static String uploadFile(final File file,final String RequestURL)
    {
        ...
        final String CONTENT_TYPE = "text/plain";   //内容类型
        ...
        try {
            ...
            if(file!=null)
            {
                ...
                /**
                 * 这里重点注意：
                 * name里面的值为服务器端,需要key   只有这个key 才可以得到对应的文件
                 * filename是文件的名字，包含后缀名的   比如:abc.png
                 */

                sb.append("Content-Disposition: text/plain; name=\"img\"; filename=\""+file.getName()+"\""+LINE_END);
